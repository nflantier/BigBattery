...
public class ModOreGen implements IWorldGenerator{
	...
	private void generateSurface(Random random, int chunkx, int chunckz, World world) {
		...
		addOreSpawn(ModBlocks.blockOreAluminium, Blocks.STONE, world, random, chunkx, chunckz, 3, 5, 1, 40, 80);
		addOreSpawn(ModBlocks.blockOreCopper, Blocks.STONE, world, random, chunkx, chunckz, 4, 16, 1, 40, 80);
		addOreSpawn(ModBlocks.blockOreLead, Blocks.STONE, world, random, chunkx, chunckz, 3, 5, 1, 20, 80);
		addOreSpawn(ModBlocks.blockOreNickel, Blocks.STONE, world, random, chunkx, chunckz, 1, 3, 1, 1, 40);
		addOreSpawn(ModBlocks.blockOrePlatinium, Blocks.STONE, world, random, chunkx, chunckz, 1, 2, 1, 1, 20);
		addOreSpawn(ModBlocks.blockOreSilver, Blocks.STONE, world, random, chunkx, chunckz, 2, 6, 1, 20, 80);
		addOreSpawn(ModBlocks.blockOreTin, Blocks.STONE, world, random, chunkx, chunckz, 3, 8, 1, 20, 80);
		addOreSpawn(ModBlocks.blockOreZinc, Blocks.STONE, world, random, chunkx, chunckz, 2, 6, 1, 20, 80);
